        ...
        <Grid className="contact-grid">
          <Cell col={6}>
            ...
            <img
              ...
              style={{height: '250px'}}
               />
             <p style={{ width: '75%', margin: 'auto', paddingTop: '1em'}}>Seeking a position to utilize my skills and abilities in a technology industry that offers
               professional growth while being resourceful, innovative and flexible.</p>
              ...
              <List>
                <ListItem>
                  <ListItemContent style={{fontSize: '30px', fontFamily: 'Anton'}}>
                    <i className="fa fa-phone-square" id="fa" aria-hidden="true"/>
                    (91) 7021170769
                  </ListItemContent>
                </ListItem>
                ...
                <ListItem>
                  <ListItemContent style={{fontSize: '35px', fontFamily: 'Anton'}}>
                    <i className="fab fa-linkedin" id="fa" aria-hidden="true"></i>
