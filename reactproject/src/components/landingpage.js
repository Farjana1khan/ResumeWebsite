    ...
    return(
      <div style={{width: '100%', margin: 'auto'}}>
        <Grid className="landing-grid">
          ...
          <p>HTML/CSS | Bootstrap | JavaScript | ReactJs | NodeJS | Jquery | CoreJava | C | Mysql</p>

        <div className="social-links">

          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/farjana-fateh-mohd-17a8441a0" 
             rel="noopener noreferrer" target="_blank">
             <i className="fab fa-linkedin" id="fab"
             aria-hidden="true" /> 
           
          </a>

          {/* Github */}
          <a href="http://github.com/Farjana1khan" 
             rel="noopener noreferrer" 
             target="_blank">
            <i className="fab fa-github-square" id="fab"
             aria-hidden="true" />
          </a>
